...
import 'package:gallery_picker_plus/controller/gallery_controller.dart';
  ...
  PickerScaffold({
    ...
    if (GetInstance().isRegistered<PhoneGalleryController>()) {
      if (initSelectedMedia != null) {
        Get.find<PhoneGalleryController>().updateSelectedFiles(initSelectedMedia!);
      }
      if (extraRecentMedia != null) {
        Get.find<PhoneGalleryController>().updateExtraRecentMedia(extraRecentMedia!);
      }
    }
  }
