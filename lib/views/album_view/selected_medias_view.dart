...
import 'package:gallery_picker_plus/views/thumbnail_media_file.dart';
...
class SelectedMediasView extends StatelessWidget {
  ...
  SelectedMediasView({super.key, required this.controller, required this.isBottomSheet}) : config = controller.config;
      ...
      child: Padding(
        ...
        child: Row(
          children: [
              ...
              child: ListView(
                ...
                children: [
                  for (var mediaFile in controller.selectedFiles)
                    Padding(
                      padding: const EdgeInsets.only(top: 3.0, bottom: 3.0, right: 2),
            ...
            TextButton(
              onPressed: () {
                if (controller.selectedFiles.length == 1 && controller.heroBuilder != null) {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute<void>(
                      builder: (BuildContext context) {
                        return controller.multipleMediasBuilder!(controller.selectedFiles, context);
                      },
                    ),
                  );
                } else {
