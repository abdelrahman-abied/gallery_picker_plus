            ...
            child: Stack(
              children: [
                PageView(
                  ...
                  children: [for (var media in widget.medias) Center(child: MediaProvider(media: media))],
                ),
                Align(
              ...
              children: [
                for (int i = 0; i < widget.medias.length; i++)
                  TextButton(
                    onPressed: () {
                      pageIndex = i;
                      controller.animateToPage(i, duration: const Duration(milliseconds: 500), curve: Curves.easeIn);
                      setState(() {});
                    },
                    child: Container(
                      width: 50,
                      ...
                      child: Text((i + 1).toString(), style: const TextStyle(fontSize: 16, color: Colors.black)),
                    ),
                  ),
              ],
            ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => MyHomePage(title: "Selected Medias", medias: widget.medias),
            ),
          );
        },
